...
test("should first item name be foo", () => {
  const taverneCeleste = new Tavern([new Item("bar", 0, 0)]);
...
test("should increase quality for 'Darnassian Blue Cheese' even after expiration", () => {
  const taverneCeleste = new Tavern([new Item("Darnassian Blue Cheese", 0, 20)]);
  const items = taverneCeleste.modifyItem();
